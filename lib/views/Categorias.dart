...
import 'package:recipeapp/models/model_allrecipes.dart' as AllRecipesModel; 
import 'package:recipeapp/services/http_connect.dart';
import 'package:recipeapp/views/Allrecipes.dart';
...
class _CategoriaScreenState extends State<CategoriaScreen> {
  ...
  Future<void> _sendLinkToRecipes(String link) async {
    try {
      final result = await HttpConnect.postData(data: {'link': link}, endpoint: 'recipes');
      print('POST enviado para /recipes com sucesso');

      // Extrair as receitas do resultado
      List<AllRecipesModel.Items>? recipes = AllRecipesModel.Autogenerated.fromJson(result).data?.items;

      // Navegar para AllRecipesScreen passando as receitas
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => AllRecipesScreen(recipes: recipes)),
      );
    } catch (e) {
